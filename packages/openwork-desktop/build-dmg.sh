...
if command -v pnpm &> /dev/null; then
    ...
    echo "❌ 错误: 未找到 pnpm 或 bun，请先安装其中一个"
    exit 1
fi
...
# 复制 DMG 到 dist 目录
DMG_NAME="OpenWork_${VERSION}_macOS.dmg"
...
echo "📥 安装说明:"
echo "   1. 双击 DMG 文件打开"
echo "   2. 将 OpenWork.app 拖拽到 Applications 文件夹"
echo "   3. 在 Applications 中启动 OpenWork"
echo ""
