...
- **安装说明**: [DEB包简单安装使用指南](./DEB包简单安装使用指南_v1.0_20260122_AI.md)
...
1. 查看 [常见问题文档](./opencode命令无法使用问题排查_v1.0_20260122_AI.md)
...
**下载链接**:
- [CLI 版本](opencode_0.0.0-dev-202601221306_amd64.deb)
- [GUI 版本](opencode-gui-installer-0.0.0-dev-202601221306-amd64.zip)
